...
*async*。
 ...
 <h4 id="_c5-return-promise">5.1.2 异步函数常返回Promise对象</h4>
...
asyncFunc().catch(err => console.log(err));//Error: Problem!
 ```
 <h4 id="_c5-await">5.1.3 用 await 进行异步计算的结果处理和错误处理</h4>
...
```
<h4 id="_c5-generators">5.2.1 通过 generator 来编写异步代码</h4>
...
<h4 id="_c5-async-functions">5.2.2 通过几个异步函数来编写异步代码</h4>
...
<h4 id="_c5-settled-asyc">5.2.3 以同步的方法开始，然后异步处理的异步函数</h4>
...
<h4 id="_c5-promise-not-wrap">5.2.4 返回没有覆盖的 Promise 对象</h4>
...
<p style="height: 5px;"></p>
<h3 id="_c5-tips-for-await">5.3 使用 await 的窍门</h3>
<p style="height: 5px;"></p>
<h4 id="_c5-donot-forget-await">5.3.1 不要忘记使用 await </h4>
...
<h4 id="_c5-fire-and-forget">5.3.2 不需要使用 await 的特殊情况</h4>
...
<h4 id="_c5-compare">5.3.3 await 是连续执行的，Promise.all() 是并行的</h4>
...
<p style="height: 5px;"></p>
<h3 id="_c5-async-func-and-cb">5.4 异步函数和回调</h3>
<p style="height: 5px;"></p>
...
<h4 id="_c5-map">5.4.1 Array.prototype.map()</h4>
...
<h4 id="_c5-foreach">5.4.2 Array.prototype.forEach()</h4>
...
<p style="height: 5px;"></p>
<h3 id="_c5-tips-for-async">5.5 使用异步函数的窍门</h3>
<p style="height: 5px;"></p>
<h4 id="_c5-know-your-promises">5.5.1 了解你使用的 Promise </h4>
...
<h4 id="_c5-invoke-async-func">5.5.2 立即调用异步函数表达式</h4>
...
<h4 id="_c5-unittest-async-func">5.5.3 用异步函数进行单元测试</h4>
...
<h4 id="_c5-donot-worry-about-unhandled-rejections">5.5.4 不要担心没有处理的拒绝态</h4>
...
<p style="height: 5px;"></p>
<h3 id="_c5-overview">5.6 阅读延伸</h3>
<p style="height: 5px;"></p>
